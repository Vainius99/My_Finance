...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <svg style="margin-left: 20%; padding-left: 15px;" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="400" height="140" preserveAspectRatio="xMidYMid meet" viewBox="0 0 40 20">
